...
namespace Groundsman.Tests
{
    ...
    public class FeatureServiceTests
    {
        ...
        private ObservableCollection<Feature> FeatureList => featureService.GetItems();
        ...
        private void AddFeature() => _ = featureService.AddItem(DefaultPoint);
        ...
        {
            _ = featureService.AddItem(DefaultPoint, false);

            Assert.AreEqual(1, FeatureList.Count);
        }
        ...
        {
            bool success = await featureService.ImportItem(DefaultPoint, false);
        ...
        public void ImportFeaturesTest()
        {
            ...
            Assert.AreEqual(3, FeatureList.Count);
        }
        ...
        public void DeleteFeatureTest()
        {
            ...
            _ = featureService.DeleteItem(FeatureList[0]);

            Assert.AreEqual(0, FeatureList.Count);
        }
        ...
        public void UpdateFeatureTest()
        {
            ...
            _ = featureService.UpdateItem(feature);

            Assert.IsTrue(FeatureList[0].Properties.ContainsKey("Test"));
        }
